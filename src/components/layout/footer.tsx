    ...
    <footer className="border-t shrink-0">
      <div className="container flex flex-col items-center gap-3 py-4 text-xs text-muted-foreground sm:flex-row sm:justify-between sm:h-10 sm:py-0 sm:gap-4">
        ...
        <nav className="flex flex-wrap items-center justify-center gap-x-4 gap-y-2">
          ...
          <Link href="https://github.com/jules-excelsior/Excelsior-Prompt-Library" target="_blank" rel="noopener noreferrer" className="hover:text-foreground flex items-center gap-1" onClick={() => analyticsExternal.clickFooterLink("github")}>
